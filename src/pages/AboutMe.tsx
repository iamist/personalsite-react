    ...
    return (
        <div id="aboutMe" className="container py-20">
            <div className="md:flex md:gap-2">
                <div className="w-full md:w-9/12 pr-20">
                    ...
                    <div className="text-2xl mt-10">
                        ...
                        <p>
                            Obviously, I pursue web development career and have been working for 17+ years. I have worked for various companies, established and start-ups and have gain professional knowledge and skills in coding from basic websites to complex web application.
                        </p>

                        <p>
                        Working with corporate companies also offered me chance to know best practices and industry standard development processes. I have also gain interest in web application design and architecture, modern technoilogies and DevOps tools.
                        </p>
                        ...
                        <p>
                        In my free time, I read anything related to technologies from <a target="_blank" href="https://news.ycombinator.com/news">Hacker News</a>.
                        </p>
                ...
                <div className="md:w-3/12">
                    <ul className="list-none full-rounded rounded-2xl bg-zinc-900 p-10">
                        <li className="flex items-center text-orange-400 mb-4">
                            <FontAwesomeIcon className="text-xl" icon={faMapPin} /> <span className="inline-block ml-2">General Trias, Cavite, Philippines</span>
                        </li>
                        <li className="mb-4">
                            <a href="mailto:vicentechristian@gmail.com" className="flex items-center">
                                <FontAwesomeIcon className="text-xl" icon={faAt} /> <span className="inline ml-2 text-left">
                                e-mail me
                                </span>
                            </a>
                        </li>
                        <li className="mb-4">
                            <a href="tel:+639175900647" className="flex items-center">
                                <FontAwesomeIcon className="text-xl" icon={faPhone} /> <span className="inline-block ml-2 self-start">
                                Call me
                                </span>
                            </a>
                        </li>
